...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.generator_Y = models.Generator(input_size,output_size)
        self.discriminator_X = models.Discriminator(input_size,output_size)
        self.discriminator_Y = models.Discriminator(input_size,output_size)
        
        # define loss functions
        self.ganLoss = models.GANLoss()
