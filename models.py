...
def Generator(input_nc, output_nc, ngf,  use_dropout=False, init_gain=0.02, gpu_ids=[]):
    """Create a generator
    Parameters:
...
def Discriminator(input_nc, ndf, n_layers_D=3,  init_gain=0.02, gpu_ids=[]):
...
class GANLoss(nn.Module):
    ...
    def __init__(self, gan_mode, target_real_label=1.0, target_fake_label=0.0):
        ...
        Parameters:
            gan_mode (str) - - the type of GAN objective. It currently supports lsgan.
